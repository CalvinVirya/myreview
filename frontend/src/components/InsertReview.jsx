        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Sharing your experience at <span className="font-semibold text-gray-700">{businessTitle}</span>
            </p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700 ml-1">Review</label>
              <textarea
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700 ml-1">Photo</label>
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  {reviewImage ? (
                    ...
                    <>
                      ...
                      <p className="text-sm text-gray-500"><span className="font-semibold text-ivy">Click to upload</span> or drag and drop</p>
