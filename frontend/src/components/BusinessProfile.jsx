...
import { 
  Star, Share2, Bookmark, MapPin, Clock, Globe, Phone, Camera, MessageCircle, Send, Smile, Navigation 
} from "react-feather";
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-gray-700 font-medium">
               ...
               <span className="text-gray-500">until {business.closeTime || "10:00 PM"}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full h-64 md:h-96 bg-gray-100 overflow-hidden relative group">
        <div className="max-w-6xl mx-auto h-full grid grid-cols-1 md:grid-cols-4 gap-1">
          <div className="md:col-span-2 h-full relative">
             <img src={business.imageUrl} className="w-full h-full object-cover hover:opacity-90 transition-opacity cursor-pointer" alt="Main" />
          </div>
          <div className="hidden md:block h-full relative">
             <img src={business.imageUrl} className="w-full h-full object-cover hover:opacity-90 transition-opacity cursor-pointer brightness-90" alt="Side 1" />
          </div>
          <div className="hidden md:block h-full relative">
             <img src={business.imageUrl} className="w-full h-full object-cover hover:opacity-90 transition-opacity cursor-pointer brightness-75" alt="Side 2" />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="border-b border-gray-200 pb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Location & Hours</h2>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1 space-y-2">
                 <div className="flex items-start gap-2">
                    <MapPin className="mt-1 text-gray-600 shrink-0" size={18} />
                    <div>
                      <p className="font-semibold text-gray-800">{business.address || "No Address Provided"}</p>
              ...
              <div className="flex-1">
                 <div className="flex items-center gap-2 mb-2 text-sm">
                    ...
                    <span className="text-gray-600">{business.openTime} - {business.closeTime}</span>
                 </div>
          ...
          <section>
            ...
            <div className="lg:hidden mb-8 border border-gray-200 rounded-lg p-4 bg-gray-50">
               ...
               >
                  ...
                  />
                  <button type="submit" className="text-serpentine hover:bg-serpentine/10 p-2 rounded-full transition-colors">
                     <Send size={18} />
                  </button>
               </form>
            </div>
             ...
             <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="p-3 border-t border-gray-200 bg-white">
                   <form 
                     ...
                     onSubmit={handleSendMessage}
                   >
                      <button type="button" className="text-gray-400 hover:text-serpentine p-2 rounded-full hover:bg-gray-50 transition-colors">
                         <Smile size={20} />
                      </button>
                      <input 
                        type="text"
                      ...
                      <button 
                        type="submit" 
                        className={`p-2 rounded-lg transition-all duration-200 ${chatMessage.trim() ? 'bg-serpentine text-white shadow-md transform scale-100' : 'bg-gray-100 text-gray-400 cursor-default scale-95'}`}
